...
<?php if (isset($_SESSION[AUTH_ID])) { ?>
    ...
    <?php } ?>
        ...
        <div class="">
          ...
          <div class="nav-item <?php echo ($_GET['page'] === 'admin-bus-list') ? 'active' : ''; ?>"><a href="<?php echo SITE_URL ?>/?page=admin-bus-list" class="py-2"><i class="bi bi-briefcase"></i><span>Businesses</span></a></div>
