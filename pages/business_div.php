...
<div id= "own-bus"class="own-bus">
        ...
        <!-- DIVISION 1 BUSINESS INFO-->
        <div id="division1" class="bus-info card border-0 rounded-5 shadow p-3 mb-5 bg-white rounded" style="display: none;">
          <div class="d-flex justify-content-between p-4">
            <h2>Business Information</h2>
            
            <a href="#" id="editButton" class="btn-edit float-end mt-4" onclick="toggleBack()">
          ...
          <div class="column d-flex row justify-content-between">
            ...
            <a href="#" class="btn-add-branch align-items-center justify-content-center" onclick="toggleBranch()">
            <i class="bi bi-plus-square"></i>
...
<!-- DIVISION 2 BRANCH INFO-->

        <div id="branch" style="display: none;" class="branch-info card border-0 rounded-5 shadow p-3 mb-5 bg-white rounded">
        <div class="d-flex justify-content-between p-4">
