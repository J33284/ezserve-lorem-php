...
function saveToDatabase( $dateCreated, $itemName, $amount, $paymentMethod, $status, $paymentId)
{
    ...
    $sql = "INSERT INTO transaction (businessCode, branchCode, busName, branchName, packName, clientID, clientName, mobileNumber, email, pickupDate, deliveryDate, deliveryAddress, transNo, paymentDate, itemList, totalAmount, paymentMethod, status) 
