                    ...
                    <div class="col-md-5">
                        ...
                        <div class="d-flex justify-content-center">
                            <div id="filelabel1" class="btn btn-primary btn-rounded" style="display: none;">
                                <label class="form-label text-white m-1" for="busImage"></label>
        ...
        <form method="post" action="?action=businessAction" enctype="multipart/form-data">
            ...
            <div class="column d-flex row justify-content-between">
                <div class="col-md-7 flex-column" style="height: 300px;">
                    ...
                    <h6>Coordinates</h6>
                    <input type="text" class="about-field form-control" name="data[coordinates]" placeholder="Enter Branch Map Location"required>
                </div>
                <div class="col-md-5">
                    <div class="mb-4 d-flex justify-content-center">
        ...
        <div class="branch-info card border-0 rounded-5 shadow p-3 mb-5 bg-white rounded">
            ...
            <form method="post" action="?action=businessAction" enctype="multipart/form-data">
                ...
                <div class="column d-flex row justify-content-between">
                    ...
                    <div class="mt-4 p-4 d-flex">
                        <button type="submit" button class="btn btn-primary" name="updateBranch" id="saveBranch_<?= $branchData['branchCode'] ?>" style="display: none;" onclick="toggleEditBranch('<?= $branchData['branchCode'] ?>')">Save</button>
